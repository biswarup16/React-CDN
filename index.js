  ...
  return (
    <div>
      <div className="container-fluid p-0">
        ...
        <div className="set-bg row" >

          <div className="col-md-7 px-5 d-flex flex-column">
            <div className="d-flex justify-content-center px-5">
              <input type="text" name="input" style={{ maxWidth: '740px' }} id="" className="form-control px-5 py-4" placeholder="Enter your City" />
            ...
            <div className="containerx">
              <h5 className="text-white">RECENT LOCATIONS</h5>
              <div className="weather-box glass text-white">
              <h3 style={{fontSize:'40px'}}>Guwahati</h3>
              <p style={{fontSize:'20px'}}>India</p>

              <p style={{fontSize:'50px'}}>24 &#8451;</p>
          ...
          {/* ---------------------------------------  */}
          <div className="col-md-5" style={{paddingTop:''}}>
          <iframe width="650" height="450" style={{borderRadius:'20px'}} src="https://www.youtube.com/embed/AzGM1y2-Bzw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
